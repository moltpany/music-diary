(function () {
  ...
  var STATIC_EN = {
    "nav.journeys": "Composers", "nav.explore": "Explore", "nav.collections": "Playlists", "nav.concerts": "Concerts",
    "nav.play": "Play one", "nav.detail": "Work detail", "nav.sources": "Sources",
    "journeys.kicker": "Composer journeys",
    "journeys.title": "Step into each composer's footstep map from here",
    "journeys.intro": "Music Diary gathers many composers; some have their own standalone “footstep map” site that unfolds by city, year and life stage. Below are the composers you can enter today — more will follow.",
    "journeys.live": "live",
    "journeys.soon": "coming soon",
    "journeys.enter": "Enter the map →",
    "journeys.comingSoon": "Coming soon",
    "journeys.mozartName": "Wolfgang Amadeus Mozart",
    "journeys.mozartDesc": "1756–1791 · a map of Mozart's footsteps alone: London, Vienna, Salzburg, Prague…",
    "journeys.beethovenName": "Ludwig van Beethoven",
    "journeys.beethovenDesc": "1770–1827 · from Bonn to Vienna: deafness, the testament, guardianship, all the way to the Ninth.",
    "journeys.chopinName": "Frédéric Chopin",
    "journeys.chopinDesc": "1810–1849 · Warsaw, Vienna, Paris, Mallorca… a Chopin footstep map is in the works.",
    "play.kicker": "Mini-game", "play.title": "Follow the score, play one on your keyboard",
    "play.intro": 'The scores are all drawn from works collected in this diary\'s playlists, written in <strong>jianpu</strong> (numbered notation: 1 = C, a dot above a number means an octave up, a dot below an octave down, ♯ is a semitone); under each number is the key to press. The layout supports <strong>two hands</strong>: the right-hand white keys are Q W E R T Y U I O P [ with black keys on the number row (2 3 5 6 7 9 0), and the left-hand bass white keys are Z X C V B N M with black keys S D G H J; the bottom row continues with <code>,</code> <code>.</code> <code>/</code> (same notes as Q W E, black keys L and ;) so the left hand can reach the middle octave without changing rows. In two-hand scores the upper and lower numbers in one slot are pressed together (one after the other counts too); you can also just click the keys below. To reach higher or lower registers, the octave ± buttons or the <code>−</code> / <code>=</code> keys shift the whole keyboard by an octave (effectively C2–F6 in free play; selecting a score snaps back to the home position so the printed key labels stay accurate). Finish a whole piece for a little surprise — more playlist melodies will be added over time. (The mini-game\'s notation and melody names are currently shown in Chinese only.)',
    ...
    "hero.sub": 'This is also the gateway to the <a href="#journeys">composer journeys</a>: Mozart and Beethoven each have their own standalone footstep map, with Chopin and more to follow.',
